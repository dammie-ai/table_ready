...
export default function CheckoutForm({
  ...
  // If /orders succeeds but /payments/confirm then fails (transient error),
  // the button re-enables — without this, resubmitting would create a
  // second order for the one card charge already taken.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (paymentIntent && paymentIntent.status === 'succeeded') {
        let createdOrderId = createdOrderIdRef.current
        ...
        if (createdOrderId === null) {
          ...
          createdOrderId = orderRes.order.master_order_id
