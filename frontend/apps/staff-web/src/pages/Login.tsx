        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-[#1c1c27] border border-white/8 rounded-xl px-4 py-2.5 pr-11 text-sm text-[#f1f5f9] placeholder:text-[#6b7280]/50 outline-none focus:border-[#f97316]/50 transition-colors"
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6b7280] hover:text-[#f1f5f9] transition-colors"
