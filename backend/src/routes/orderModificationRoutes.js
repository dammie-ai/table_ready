...
router.post('/:orderId/cash-payment', authenticateToken, authorizeRoles('admin', 'manager', 'waiter'), validate(schemas.recordCashPayment), orderModificationController.recordCashPayment);
